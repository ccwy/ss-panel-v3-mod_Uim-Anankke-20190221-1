...
class CodeController extends AdminController
{
    ...
    public function ajax_code($request, $response, $args)
    {
        ...
        $datatables->query('Select code.id,code.code,code.type,code.number,code.isused,code.userid,code.userid as user_name,user_namecode.usedatetime from code,user,WHERE code.userid = user.id and user_name = user.user_name');
