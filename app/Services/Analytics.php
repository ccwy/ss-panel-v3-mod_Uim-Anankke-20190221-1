...
class Analytics
{
   ...
   //返利
    ...
    {
        return User::where('class', '>', 1)->where('id','!=',2291)->where('id','!=',2293)->where('id','!=',1772)->count();
    }
	//统计全站已用总流量
    ...
    {
        return User::where('class', '>', 1)->where('class', '<', 22)->where('id','!=', 2291)->where('id','!=', 2293)->where('id','!=',1772)->count();
