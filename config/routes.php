...
$app->group('/user', function () {
	...
	$this->get('/guide', 'App\Controllers\UserController:guide');   //教程
...
$app->group('/admin', function () {
	...
	$this->get('/user/usercode', 'App\Controllers\AdminController:user_code');
...
//邮件纪律
	...
	$this->post('/ticket/{id}', 'App\Controllers\Admin\TicketController:update_money');// 更新用户余额
