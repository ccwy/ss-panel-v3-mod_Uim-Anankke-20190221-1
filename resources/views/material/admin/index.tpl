                                        ...
                                        <script>
											var chart = new CanvasJS.Chart("check_chart",
											{
												...
												data: [
												{
													...
													dataPoints: [
													    {
															y: {$sts->fourdayIncome()/$sts->thisyearIncome()*100}, legendText:"大大前日流水 {number_format($sts->fourdayIncome()/$sts->thisyearIncome()*100,2)}% {$sts->fourdayIncome()}元", indexLabel: "大大前日流水日流水 {number_format($sts->fourdayIncome()/$sts->thisyearIncome()*100,2)}% {$sts->fourdayIncome()}元"
														},
														{
															y: {$sts->threedayIncome()/$sts->thisyearIncome()*100}, legendText:"大前日流水 {number_format($sts->threedayIncome()/$sts->thisyearIncome()*100,2)}% {$sts->threedayIncome()}元", indexLabel: "大前日流水日流水 {number_format($sts->threedayIncome()/$sts->thisyearIncome()*100,2)}% {$sts->threedayIncome()}元"
														},
														{
															y: {$sts->twodayIncome()/$sts->thisyearIncome()*100}, legendText:"前日流水 {number_format($sts->twodayIncome()/$sts->thisyearIncome()*100,2)}% {$sts->twodayIncome()}元", indexLabel: "前日流水日流水 {number_format($sts->twodayIncome()/$sts->thisyearIncome()*100,2)}% {$sts->twodayIncome()}元"
														},
														{
															y: {$sts->yesterdayIncome()/$sts->thisyearIncome()*100}, legendText:"昨日流水 {number_format($sts->yesterdayIncome()/$sts->thisyearIncome()*100,2)}% {$sts->yesterdayIncome()}元", indexLabel: "昨日流水日流水 {number_format($sts->yesterdayIncome()/$sts->thisyearIncome()*100,2)}% {$sts->yesterdayIncome()}元"
														},														
														{
