					...
					<div class="auth-main auth-row">
										        ...
										        <div class="btn-auth auth-row" style="color: #ff4081">
										            <div class="checkbox checkbox-adv">
										                <label for="agree">
                                                          ...
                                                          <span>我已阅读并知晓<a href="/toos">用户协议</a>；<br>我知晓违规使用将导致账号被删除；<br>您必须点击这里同意用户协议</span>
						...
						<div class="auth-bottom auth-row auth-reg">
							<div class="tgauth">
								...
								<p>注册即代表同意并愿意遵守本站<a href="/toos">用户协议（TOS）</a>，以及保证所录入信息的真实性，如有不实信息会导致账号被删除。</p>
...
<script type="text/javascript">
		...
		if($("#agree").prop("checked")){
			$("#tos").attr('disabled',false);//按钮可用
		}
		else{
			$("#tos").attr('disabled',true);//按钮不可用
		} 
	});
