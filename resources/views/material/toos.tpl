                                   ...
                                   <div class="table-wrapper">
										<table>
											...
											<tbody>
												...
												<tr>
													<td>本站每个用户最多可同时在线3个设备，无速度限制，正常流量比例为1，本站会根据实际运营情况及各种不可抗拒因素随时，<br>调整节点域名、节点IP、节点数量、节点流量比例等</td>													
												</tr>
                                                <tr>
												...
												<tr>
												    <td>本站默认为每个用户设置有审计规则，审计规则会屏蔽BT/PT/P2P/SMTP、以及一些政治敏感网站、流氓软件、流氓网站等，<br>如不接受，请停止注册和使用本站服务，审计规则<a href="/user/detect">点这里查看</a>，请不要违反审计规则</td>
												</tr>
												<tr>
