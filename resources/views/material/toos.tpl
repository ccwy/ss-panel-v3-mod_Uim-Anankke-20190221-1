                                   ...
                                   <div class="table-wrapper">
										<table>
											...
											<tbody>
												...
												<tr>
												    <td>本站默认为每个用户设置有审计规则，审计规则会屏蔽BT/PT/P2P/SMTP、以及一些政治敏感网站、流氓软件、<br>流氓网站等，如不接受，请停止注册和使用本站服务，审计规则<a href="/user/detect">点这里查看</a>，请不要违反审计规则，违反审计规则可能会导致账号被删除或被停止使用</td>
												</tr>
												<tr>
