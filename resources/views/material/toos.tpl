			...
			<div id="wrapper">
			  ...
			  <table>
										<tbody>
												...
												<tr>
													<td>本站会以SHA256加密存储用户密码，本站不会记录用户的浏览数据，所有服务器无日志形式运行。</td>
													
												</tr>
												
												<tr>
													<td>本站默认屏蔽中国大陆访问，中国大陆地区打开本站可能会出现各种错误 </td>
                                   ...
                                   <div class="table-wrapper">
										<table>
											...
											<tbody>
												...
												<tr>
													<td>禁止滥用本站提供的服务，如：使用本站节点进行BT下载、PT下载、P2P下载、发送垃圾邮件、DDOS攻击、CC攻击、<br>爬虫、嗅探、攻击各种软件漏洞、政府机构、金融机构等一切滥用；如被发现，将直接删除账号</td>													
												</tr>
                                                <tr>
													<td>禁止在任何地方公布、泄露、透露节点地址，禁止在任何论坛、贴吧等公共场所留下本站邀请链接或邀请码，如被发现，<br>将直接删除账号</td>													
												</tr>
												<tr>
													<td>本站每个用户最多可同时在线3个设备，正常流量倍率为1，本站会根据实际运营情况及各种不可抗拒因素<br>随时，在不通知的情况下调整节点域名、节点IP、可用节点数量、节点流量倍率等</td>													
												</tr>
                                                <tr>
													<td>本站无游戏节点，无法保证游戏效果；本站节点不保证能观看TVB、Netflix、Hulu等视频网站</td>													
												</tr>
												<tr>
													<td>为防止有人不听劝告，利用本站节点发送垃圾邮件，本站默认屏蔽SMTP发信端口</td>													
												</tr>
												<tr>
												    <td>本站默认为每个用户设置有审计规则，审计规则会屏蔽BT/PT/P2P/SMTP、以及一些政治敏感网站、流氓软件、<br>流氓网站等，如不接受，请停止注册和使用本站服务，审计规则<a href="/user/detect">点这里查看</a>，请不要违反审计规则，<br>违反审计规则可能会导致账号被删除或被停止使用</td>
												</tr>
												<tr>
												    <td>本站不提供 退款、试用、以及技术支持，使用方法请看<a href="/user/guide">使用教程</a></td>
												</tr>
													
												<tr>
													<td>所有注册用户必需遵守网站用户协议（TOS），如果您无法接受，请您不要注册及停止使用本站服务</td>													
												</tr>
