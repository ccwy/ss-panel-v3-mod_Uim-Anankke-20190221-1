                  ...
                  <div class="card">
					  <div class="card-main">
								...
								{if $shop->id == 68 }
									...
									<div class="shop-content-left">仅重置流量为50G</div><div class="shop-content-right"></div>
									<div class="shop-content-left">仅限流量用尽购买</div><div class="shop-content-right"></div>
									<div class="shop-content-left">仅限年付用户购买</div><div class="shop-content-right"></div>
								{else}
