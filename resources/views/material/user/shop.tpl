					...
					<div class="card">
						<div class="card-main">
							<div class="card-inner">
								...
								3，套餐不可叠加，新购套餐会覆盖旧套餐的效果，本站不提供任何技术支持，使用方法请看教程。<br>
								</p>
							</div>
						</div>
					</div>
                  ...
                  <div class="card">
					  <div class="card-main">
								...
								{if $shop->id == 68 }
									...
									<div class="shop-content-left">仅重置流量为50G</div><div class="shop-content-right"></dev>
									<div class="shop-content-left">仅限流量用尽购买</div><div class="shop-content-right"></dev>
									<div class="shop-content-left">仅限年付用户购买</div><div class="shop-content-right"></dev>
								{else}
