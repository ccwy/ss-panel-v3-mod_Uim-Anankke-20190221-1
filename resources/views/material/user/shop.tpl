						...
						<div class="card-main">
							<div class="card-inner">
								<p><i class="icon icon-lg">monetization_on</i>&nbsp;余额：&nbsp;<font color="red" size="5">{$user->money}</font>&nbsp;元</p>
								    ...
								    2，本站无游戏节点，不保证可以观看TVB\NF\huhu等视频网站；<font color="red">套餐不可叠加，新购套餐会覆盖旧套餐的效果；</font><br>							    
									3，不同套餐可用节点数量不同，高等级可使用全部低等级节点；本站不提供退款，本站不提供任何技术支持，使用方法请看<a href="/user/guide">使用教程</a>。
								</p>
							</div>
						</div>
					</div>
