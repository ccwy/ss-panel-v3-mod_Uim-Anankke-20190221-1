                  ...
                  <div class="card">
					  <div class="card-main">
								...
								<div class="shop-content">
									...
									<div class="shop-content-left">重置频率:</div><div class="shop-content-right">{if $shop->auto_reset_day == 0 }N / A{else}{$shop->bandwidth()}<span>G</span> / {$shop->class_expire()}<span>天</span>{/if}</div>
								</div>
            ...
            <div class="shop-table">
					...
					<div class="shop-gridarea">
						...
						<div class="shop-drop dropdown-area">
							...
							<div class="card-tag tag-black">重置频率</div><div class="card-tag tag-blue">{$shop->bandwidth()}G/{$shop->class_expire()}天</div>
							{/if}
