...
<script src="/theme/material/js/jquery3.3.1.min.js"></script>
						...
						{if $node['class']!=$class}
							...
							<div class="nodetitle">
								<a class="waves-effect waves-button" data-toggle="collapse" href="#cardgroup{$class}" aria-expanded="true" aria-controls="cardgroup{$class}">
								    <span>{if $class == 0}普通{/if}{if $class == 3}VIP{/if}{if $class == 11}VIP1{/if}{if $class == 12}VIP2{/if}{if $class == 13}VIP3{/if}{if $class == 14}VIP4{/if}{if $class >=23}SVIP1{/if}(节点禁ping)</span><i class="material-icons">expand_more</i>
								</a>
							</div>
						...
						<div class="node-card node-flex" cardindex="{$node@index}">
                            <div class="nodemain">
                                ...
                                <div class="nodemiddle node-flex">
                                    <div class="onlinemember node-flex"><i class="material-icons node-icon">flight_takeoff</i>         <span>{if $node['online_user'] == -1} N/A{else} {$node['online_user']}{/if}</span>    人在线</div>
								...
								<div class="card-inner margin-bottom-no">
									<div class="tile-wrap">        
										...
										{if $node['class']!=$class}
											...
											<p class="card-heading">{if $class == 0}普通{/if}{if $class == 3}VIP{/if}{if $class == 11}VIP1{/if}{if $class == 12}VIP2{/if}{if $class == 13}VIP3{/if}{if $class == 14}VIP4{/if}{if $class >=23}SVIP1{/if}(节点禁ping)</p>	
										{/if}
