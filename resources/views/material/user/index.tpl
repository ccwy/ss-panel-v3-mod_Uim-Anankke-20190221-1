							...
							<div class="card">
								<div class="card-main">
									...
									<div class="card-action">
									    {*<p>小游戏：每天可签到一次，每次签到随机获得 {$config["checkinMin"]}MB ~ {$config["checkinMax"]}MB 流量，<a href="/user/checktimelog">签到记录</a>。</p>*}
										<p>小游戏：每天可签到一次，签到随机获得一些流量。</p>
...
function urlChange(iphone_shadowrocket) {
		...
		doc.open();
		doc.write('<img src="/images/iphone_shadowrocket.gif" style="width: 100%;height: 100%; border: none;"/>');
		doc.close();
	$("#nodeinfo").modal();
}
</script>
