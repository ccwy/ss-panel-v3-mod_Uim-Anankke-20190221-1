							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner">
										...
										<p class="form-control-guide"><i class="material-icons">info</i>填写付款订单号可在支付宝账单/微信付款凭证里面找到</p>
                                        </div>
										<div class="form-group form-group-label">
										...
										<p class="form-control-guide"><i class="material-icons">info</i>填写实际付款时间，支付宝账单/微信支付凭证里面有的</p>
										</div>
